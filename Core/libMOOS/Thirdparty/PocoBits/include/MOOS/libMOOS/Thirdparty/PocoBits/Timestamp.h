...
#ifndef MOOS_POCO_Foundation_Timestamp_INCLUDED
#define MOOS_POCO_Foundation_Timestamp_INCLUDED
...
class MOOS_POCO_Foundation_API Timestamp
...
#endif // MOOS_POCO_Foundation_Timestamp_INCLUDED
