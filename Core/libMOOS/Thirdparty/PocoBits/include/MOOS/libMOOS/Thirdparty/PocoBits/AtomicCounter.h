...
#ifndef MOOS_POCO_Foundation_AtomicCounter_INCLUDED
#define MOOS_POCO_Foundation_AtomicCounter_INCLUDED
...
class MOOS_POCO_Foundation_API AtomicCounter
...
#endif // MOOS_POCO_Foundation_AtomicCounter_INCLUDED
