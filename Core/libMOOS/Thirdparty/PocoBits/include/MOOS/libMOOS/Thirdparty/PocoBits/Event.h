...
#ifndef MOOS_POCO_Foundation_Event_INCLUDED
#define MOOS_POCO_Foundation_Event_INCLUDED
...
class MOOS_POCO_Foundation_API Event: private EventImpl
...
#endif // MOOS_POCO_Foundation_Event_INCLUDED
