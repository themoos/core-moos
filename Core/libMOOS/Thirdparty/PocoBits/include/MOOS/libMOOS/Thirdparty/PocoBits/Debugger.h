...
#ifndef MOOS_POCO_Foundation_Debugger_INCLUDED
#define MOOS_POCO_Foundation_Debugger_INCLUDED
...
class MOOS_POCO_Foundation_API Debugger
...
#endif // MOOS_POCO_Foundation_Debugger_INCLUDED
