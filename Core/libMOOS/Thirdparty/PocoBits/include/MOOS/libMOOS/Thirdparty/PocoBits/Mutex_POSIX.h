...
#ifndef MOOS_POCO_Foundation_Mutex_POSIX_INCLUDED
#define MOOS_POCO_Foundation_Mutex_POSIX_INCLUDED
...
class MOOS_POCO_Foundation_API FastMutexImpl: public MutexImpl
{
protected:
	FastMutexImpl();
	~FastMutexImpl();
...
#endif // MOOS_POCO_Foundation_Mutex_POSIX_INCLUDED
